...
export const RUNTIME_ENV = {
  ...
  langSearch: [
    'LANGSEARCH_API_KEY', 'LANGSEARCH-API-KEY', 'LANG_SEARCH_API_KEY',
    'LANGSEARCH_API_KEY_1', 'LANGSEARCH-API-KEY-1', 'LANG_SEARCH_API_KEY_1',
    'LANGSEARCH_KEY', 'LANGSEARCH-KEY',
  ],
  langSearch2: [
    'LANGSEARCH_API_KEY_2', 'LANGSEARCH-API-KEY-2', 'LANG_SEARCH_API_KEY_2',
    'LANGSEARCH_KEY_2', 'LANGSEARCH-KEY-2',
  ],
  ...
  maptiler: ['NEXT_PUBLIC_MAPTILER_API_KEY', 'MAPTILER_API_KEY', 'MAPTILER_KEY', 'MAPTILER_API_TOKEN', 'MAPTILER-API-KEY'],
  groq1: ['GROQ_API_KEY'],
  ...
  algoliaAppId: [
    'ALGOLIA_APP_ID', 'ALGOLIA_APPLICATION_ID', 'ALGOLIA_APPID', 'ALGOLIA_APPLICATIONID',
    'NEXT_PUBLIC_ALGOLIA_APP_ID', 'NEXT_PUBLIC_ALGOLIA_APPLICATION_ID',
  ],
  algoliaSearchKey: ['ALGOLIA_SEARCH_API_KEY', 'ALGOLIA_API_KEY', 'NEXT_PUBLIC_ALGOLIA_SEARCH_API_KEY'],
  ...
  sam: ['SAM_API_KEY', 'SAM_GOV_API_KEY'],
  nlx: ['NLX_API_KEY'],
} as const;
