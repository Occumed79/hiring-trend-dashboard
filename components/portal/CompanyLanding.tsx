...
const PORTAL_COPY: Record<string, PortalCopy> = {
  current_clients: {
    ...
    plural: 'Clients',
    action: 'Track Client',
    description: 'Search or add any client and track verified hiring activity over time.',
  },
  prospects: {
    singular: 'Prospect',
    plural: 'Prospects',
    action: 'Track Prospect',
    description: 'Search or add any prospect and monitor verified hiring signals over time.',
  },
  private_companies: {
    singular: 'Company',
    plural: 'Companies',
    action: 'Track Company',
    description: 'Search or add a private company and track verified hiring activity across its authoritative career sources.',
  },
  federal_agencies: {
    singular: 'Federal Agency',
    plural: 'Federal Agencies',
    action: 'Track Agency',
    description: 'Track federal hiring through verified USAJOBS agency inventories and authoritative agency career sources.',
  },
  state_agencies: {
    singular: 'State Agency',
    plural: 'State Agencies',
    action: 'Track Agency',
    description: 'Track state-agency hiring from official government and ATS career systems.',
  },
  counties_and_cities: {
    singular: 'County / City',
    plural: 'Counties & Cities',
    action: 'Track County / City',
    description: 'Track county and city hiring from official local-government career boards and ATS systems.',
  },
};
