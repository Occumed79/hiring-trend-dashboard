...
export default function SourceHealthView() {
  ...
  return <div className="min-h-full p-5 lg:p-6 space-y-5 max-w-[1650px] mx-auto">
    ...
    <section className="glass-card luminous-panel p-5"><div className="flex items-start justify-between gap-4 flex-wrap mb-4"><div><h2 className="text-[15px] font-semibold text-slate-100">Ground Truth Capture</h2><p className="mt-1 text-[10px] text-slate-600">Capture an independent official-site count and, ideally, the complete set of official job URLs. Complete URL sets unlock exact precision and recall.</p></div><span className="rounded-full border border-cyan-400/20 bg-cyan-500/8 px-2.5 py-1 text-[9px] text-cyan-200">{summary.truth_entities||0} entities verified</span></div>
